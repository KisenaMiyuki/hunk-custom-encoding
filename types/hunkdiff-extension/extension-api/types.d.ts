 ...
 */
export declare const HUNK_EXTENSION_API_VERSION = 25;
 ...
 */
export declare const HUNK_EXTENSION_USER_ERROR_NAME = "HunkExtensionUserError";
 ...
 * ```
 */
export declare class HunkExtensionUserError extends Error {
...
export type ChangesetTransform = (changeset: ExtensionChangeset, ctx: ExtensionContext) => ExtensionChangeset | Promise<ExtensionChangeset>;
/**
...
export interface ExtensionFileView {
    ...
    layout(input: ExtensionFileViewInput): ExtensionFileViewLayout | null | Promise<ExtensionFileViewLayout | null>;
    /**
...
export interface ExtensionLineHighlighter {
    ...
    highlight(input: ExtensionLineHighlightInput): readonly ExtensionLineHighlight[] | null | Promise<readonly ExtensionLineHighlight[] | null>;
}
...
export interface ExtensionLineHighlightControls {
     ...
     */
    refresh(highlighterId: string, options?: {
        fileId?: string;
    }): void;
}
 ...
 */
export declare const HUNK_VCS_DETECTION_BASELINE_PRIORITY = 0;
/** @deprecated Use `HUNK_VCS_DETECTION_BASELINE_PRIORITY`. */
export declare const HUNK_CORE_VCS_DETECTION_PRIORITY = 0;
/**
 ...
 */
export declare const HUNK_DEFAULT_VCS_DETECTION_PRIORITY = -100;
...
export interface ExtensionVcsHistorySource {
    ...
    read(options: {
        limit: number;
        signal?: AbortSignal;
    }): Promise<ExtensionVcsHistoryPage>;
...
export type ExtensionVcsHistoryRangeReviewAction = Extract<ExtensionVcsHistoryReviewAction, {
    kind: "revision-range";
}>;
...
export interface ExtensionVcsHistoryCapability {
    open(input: ExtensionVcsHistoryInput, context: ExtensionVcsLoadContext): ExtensionVcsHistorySource | Promise<ExtensionVcsHistorySource>;
    /**
     ...
     */
    planReview(commit: ExtensionVcsHistoryCommit, context: ExtensionVcsLoadContext, options?: ExtensionVcsHistoryReviewOptions): ExtensionVcsHistoryReviewAction | Promise<ExtensionVcsHistoryReviewAction>;
    /**
     ...
     */
    planRangeReview?(selection: ExtensionVcsHistoryRangeSelection, context: ExtensionVcsLoadContext, options?: ExtensionVcsHistoryReviewOptions): ExtensionVcsHistoryRangeReviewAction | Promise<ExtensionVcsHistoryRangeReviewAction>;
}
...
export type ExtensionVcsFileChangeType = "change" | "rename-pure" | "rename-changed" | "new" | "deleted";
...
export type ExtensionVcsFileSourceReader = (request: ExtensionVcsFileSourceRequest) => Promise<ExtensionVcsFileSourceResult>;
...
export type ExtensionVcsWatchTarget = ExtensionVcsDirectoryEntriesWatchTarget | ExtensionVcsDirectoryTreeWatchTarget;
/**
...
export type ExtensionReviewDescriptor = ExtensionChangeRequestReviewDescriptor | ExtensionCommitReviewDescriptor | ExtensionComparisonReviewDescriptor;
...
export type ExtensionCliCommandHandler = (args: readonly string[], ctx: ExtensionCliCommandContext) => ExtensionCliCommandResult | Promise<ExtensionCliCommandResult>;
/**
...
export type ExtensionCustomEventHandler<Payload = unknown> = (payload: Payload, ctx: ExtensionEventContext) => void | Promise<void>;
/**
...
export type ExtensionEventHandler<Event extends ExtensionEventName = ExtensionEventName> = (payload: ExtensionEventPayloads[Event], ctx: ExtensionEventContext) => void | Promise<void>;
/**
